...
参赛队伍需撰写技术报告，报告可使用中文或英文撰写。

### 9.1 模板要求

- 技术报告统一使用 **CCL 2024 论文模板**。
- 论文模板下载链接：[CCL 2024 LaTeX 模板](http://cips-cl.org/static/CCL2024/downloads/ccl2023_template.zip)
- 会议投稿需统一使用 **LaTeX 模板**。
...
由于本次会议采用双盲审稿，作者姓名和单位不能出现在投稿论文中。

作者在引用本人已有工作时，不应使用“我们提出……”等暴露身份的表述，建议采用第三人称方式，例如：
